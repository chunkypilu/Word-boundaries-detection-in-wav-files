...
model.fit(train_X, train_y, nb_epoch=15, batch_size=1, verbose=2,validation_data=(test_X, test_y ))

model.summary()

model.save('/home/emblab/Desktop/Assignment_3__/model_final.h5')
#
#a=train_X[0,:,:]
#b=train_y[0,:,:]
